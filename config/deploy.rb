...
set :application_name, 'rails_sample'
set :domain, 'rails_sample.mzaidannas.me'
set :deploy_to, '/home/ubuntu/rails_sample'
set :repository, 'git@github.com:mzaidannas/rails_sample.git'
set :branch, 'main'
